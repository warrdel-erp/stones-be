...
ALTER TABLE po_supplier_invoice_mapper
ADD COLUMN vessel INT DEFAULT NULL,
ADD COLUMN airBill INT DEFAULT NULL,
ADD COLUMN plannedExFactoryDate DATE DEFAULT NULL,
ADD COLUMN exFactoryDate DATE DEFAULT NULL,
ADD COLUMN departurePort INT DEFAULT NULL,
ADD COLUMN etdPort DATE DEFAULT NULL,
ADD COLUMN etaPort DATE DEFAULT NULL,
ADD COLUMN arrivalPort INT DEFAULT NULL,
ADD COLUMN dischargePort INT DEFAULT NULL;
ADD COLUMN wiringInstruction INT DEFAULT NULL;
