...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `UPDATE customers SET paymentTermId = CAST(paymentTerms AS UNSIGNED) WHERE paymentTerms IS NOT NULL`,
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `UPDATE customers SET paymentTerms = CAST(paymentTermId AS CHAR) WHERE paymentTermId IS NOT NULL`,
      { type: Sequelize.QueryTypes.UPDATE }
    );
